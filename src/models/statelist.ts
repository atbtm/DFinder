export const statelist = [{ state: "Alabama", code: "AL" },
...
{ state: "Dist. of Columbia", code: "DC" },
...
{ state: "Northern Marianas", code: "MP" },
{ state: "Ohio", code: "OH" },
